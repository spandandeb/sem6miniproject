...
const calculateMatchScore = (student: User, mentor: Mentor): number => {
  let score = 0;
  const weights = {
    skills: 0.4,
    industry: 0.3,
...
const MentorMatch: React.FC = () => {
  ...
  // Apply content-based filtering on component mount
  useEffect(() => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Our AI-powered system matches you with mentors based on your skills, interests, and career goals.
        </p>
      </div>
